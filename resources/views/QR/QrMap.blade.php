    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="breadcrumb-hero">
        <div class="container">
          <div class="breadcrumb-hero">
            <h2>Add Location</h2>
            <p>Choose your method to update your current Location</p>
          </div>
        </div>
      </div>
      <div class="container">
        ...
        <div class="row justify-content-around">
           <div class="col-3">
            <article class="entry">
              ...
              <div class="cvr">
                <img src="assets/img/qr-code.png" class="img-fluid">
              </div>
              ...
              <div class="col-3">
                <article class="entry">
                  ...
                  <div class="cvr">
                    <img src="assets/img/download.png" class="img-fluid">
                  </div>
                
                    <div class="QrMap">
                      <a href="EditLocMap{{$id}}">
                      <button class="form-btn">
                        Add Location
                      </button></a>
                    </div>
